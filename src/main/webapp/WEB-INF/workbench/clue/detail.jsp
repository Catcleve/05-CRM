...
<div style="position: relative; left: 40px; top: -30px;">
    ...
    <div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
        <button type="button" class="btn btn-default" onclick="window.location.href='/crm/toView/workbench/clue/convert';"><span
...
<div>
    <div style="position: relative; top: 60px; left: 40px;">
        ...
        <div>
            <a href="javascript:" onclick="getActivities(1,5,'')" data-toggle="modal" data-target="#bindModal"
...
<script>
        ...
        $.post("/crm/workbench/clue/getActivity",{
            ...
            function(data){
                ...
                $(data.list).each(function (index, item) {
                    $("#activityListBody").append(`<tr>
                        <td>`+ item.name+`</td>
                        <td>`+ item.startDate+`</td>
                        <td>`+ item.endDate+`</td>
                        <td>`+ item.owner+`</td>
                        <td><a href="javascript:" onclick='unBind("` + item.id + `")' style="text-decoration: none;"><span
    ...
    //关联市场活动模态框中输入框选中时按下enter键查询未绑定的
    ...
    function bindActivity() {
        ...
        $bind.each(function (index,item) {
            bindActive.push($(item).val())
        });

        $.post("/crm/workbench/clue/bindActivities",{
            clueId:clue.id,
            ids:bindActive.join()
        },function(data){
            activityList()
